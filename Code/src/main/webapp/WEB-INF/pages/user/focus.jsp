                        ...
                        <c:forEach var="items" items="${goodsAndImage}">
                            <div class="story">
                                ...
                                <div class="box">
                                    ...
                                    <div class="interact">
                                        <span class="fa fa-heart fa-lg"><a href="<%=basePath%>goods/goodsId/${items.goods.id}">Go buy</a></span>
                                        <span class="fa fa-heart-o fa-lg"><a href="<%=basePath%>user/deleteFocus/${items.goods.id}">Unlike</a></span>
                                    </div><br>
                                    <div class="like_detail">
                                        <div class="like_content">
                                            <span>Sold date：${items.goods.endTime}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
